...
/*package*/ class EnumCheck_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public EnumCheck_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_xdkd2q_a");
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new leftExpressionSingleRoleHandler_xdkd2q_a0(myNode, LINKS.leftExpression$GG$V, getEditorContext());
    return provider.createCell();
  }
  private static class leftExpressionSingleRoleHandler_xdkd2q_a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public leftExpressionSingleRoleHandler_xdkd2q_a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.leftExpression$GG$V, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.leftExpression$GG$V, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.leftExpression$GG$V);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.leftExpression$GG$V));
      try {
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_xdkd2q_b0");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.enum$68Ng;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.enum$68Ng);
    }
